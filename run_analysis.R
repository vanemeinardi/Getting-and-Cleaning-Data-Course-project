...
#colNames <- gsub("mad","MedAbsDev",colNames)
#colNames <- gsub("max","Max",colNames)
#colNames <-  gsub("min","Min",colNames)
#colNames <- gsub("sma","SigMagArea",colNames)
#colNames <- gsub("energy","Energy",colNames)
#colNames <- gsub("iqr","InterqRange",colNames)
#colNames <- gsub("entropy","Entropy",colNames)
#colNames <- gsub("arCoeff","AutoRegCoeff",colNames)
#colNames <- gsub("correlation","Correlation",colNames)
colNames <-  gsub("^(f)","Freq",colNames)
#colNames <- gsub("kewness","Kewness",colNames)
#colNames <-  gsub("kurtosis","Kurtosis",colNames)
#colNames <- gsub("bands","Bands",colNames)
